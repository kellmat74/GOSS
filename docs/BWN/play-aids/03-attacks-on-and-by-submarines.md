# Play Aid 3 — Attacks on and by Submarines

> Source: Compass Games BWN Play Aids PDF, page 3. Transcribed verbatim.
> Margin annotations: handwritten "Blue" with section refs §17.8, §17.9, §17.11, §17.9.
> Each H2 below is a workflow chunk — when the active player initiates ASW or a sub attack, surface the matching section.
...
- -2 DRM if diesel submarine and target TF is Fast
- -2 DRM for missile coordination per unit after the 1st (example: -2 DRM for 2 units, -4 DRM for 3 units)
