...
export function RuleModal() {
  ...
  return createPortal(
    <div
      ...
      className="fixed inset-0 z-[200] flex items-center justify-center bg-black/60 p-4 animate-in fade-in duration-150"
    >
 ...
 *  Hive Mind block removed v4.10.12 — forum data is still loaded into
 *  RulesContext for the Ask tab's searchForum() retrieval, just no longer
 *  surfaced as snippets here. */
function ModalBody({
  activeRule,
  getRulesForSection,
  getRuleBySection,
