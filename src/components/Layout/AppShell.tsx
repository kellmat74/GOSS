    ...
    <div className="flex h-screen bg-white text-stone-900 dark:bg-stone-900 dark:text-stone-100">
      ...
      >
        <div className="sticky top-0 z-10 border-b border-stone-200 bg-stone-50 p-3 dark:border-stone-700 dark:bg-stone-800">
          <h1 className="text-lg font-bold tracking-tight">GOSS Assistant <span className="text-xs font-normal text-stone-500">v1.5</span></h1>
      ...
      <div className="flex min-w-0 flex-1 flex-col">
        ...
        <header className="flex items-center border-b border-stone-200 bg-white px-3 py-2 dark:border-stone-700 dark:bg-stone-800">
          ...
          >
            {theme === "dark" ? (
              <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 3v1.5 16v1m9-9h-1M4 12H3m15.364 6.364l-.707-.707M6.343 6.343l-.707-.707m12.728 0l-.707.707M6.343 17.657l-.707.707M16 12a4 4 0 11-8 0 4 4 0 018 0z" />
              </svg>
            ) : (
              <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
