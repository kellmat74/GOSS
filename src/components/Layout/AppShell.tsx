      ...
      {!hideSidebar && (
        ...
        >
          <div className="sticky top-0 z-10 border-b border-stone-200 bg-stone-50 p-3 dark:border-stone-700 dark:bg-stone-800">
            <h1 className="text-lg font-bold tracking-tight">{title} <span className="text-xs font-normal text-stone-500">v4.11.13</span></h1>
            {subtitle && (
          ...
          <div className="flex items-center gap-2">
            {hideSidebar ? (
              <span className="mr-1 whitespace-nowrap text-sm font-bold tracking-tight">
                {title}{" "}
                <span className="text-xs font-normal text-stone-500">v4.11.13</span>
              </span>
            ) : (
              <button
                onClick={() => {
